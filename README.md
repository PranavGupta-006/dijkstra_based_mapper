...
Load the graph dataset from data.csv.

Send a request to the backend specifying the start and destination nodes.

The backend runs Dijkstra’s algorithm.

The computed shortest path is returned to the frontend.
...
If you want, I can also make a much stronger README (the kind that gets attention on GitHub) with:
